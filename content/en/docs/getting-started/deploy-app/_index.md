...
2. Follow the same steps as with PostgreSQL, but for Redis application.
3. The Redis application has an `authEnabled` parameter, which will create a default user. That’s sufficient for our application.
4. Once you're done configuring the parameters, click the **Deploy** button. The application will be installed in your tenant.
...
4. The password is shown in the **Secrets** section, with buttons to copy or reveal it.
